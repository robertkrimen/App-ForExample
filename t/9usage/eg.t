...
sub stdout_same_as (&$;$) {
    ...
    unlike $content, qr/\bUsage: for-example\b/;
...
stdout_same_as { run_build qw# catalyst/fastcgi apache2 standalone --bare # } 't/assets/apache2/fastcgi-standalone';
stdout_same_as { run_build qw# catalyst/fastcgi apache2 standalone --bare --fastcgi-socket #, $fastcgi_socket } 't/assets/apache2/fastcgi-standalone-host-port';
...
stdout_same_as { run_build qw# catalyst/fastcgi nginx --bare # } 't/assets/nginx/standalone';
stdout_same_as { run_build qw# catalyst/fastcgi nginx --bare --fastcgi-socket #, $fastcgi_socket } 't/assets/nginx/standalone-host-port';
stdout_same_as { run_build qw# catalyst/fastcgi lighttpd standalone --bare # } 't/assets/lighttpd/standalone';
stdout_same_as { run_build qw# catalyst/fastcgi lighttpd standalone --bare --fastcgi-socket #, $fastcgi_socket } 't/assets/lighttpd/standalone-host-port';
stdout_same_as { run_build qw# catalyst/fastcgi lighttpd static --bare --fastcgi-socket /tmp/lighttpd-eg.socket # } 't/assets/lighttpd/static';
